...
public class RegisterActivity extends AppCompatActivity {
        ...
        buttonMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validateInput(txtUsername, txtEmail, txtPassword, txtDateOfBirth)) {
                    ...
                    registerViewModel.registerUser(user, txtPassword, RegisterActivity.this);
                }
            }
        });
    ...
    private boolean validateInput(String username, String email, String password, String dateOfBirth) {
        if (TextUtils.isEmpty(username)) {
            Toast.makeText(RegisterActivity.this, "Please enter your full username", Toast.LENGTH_LONG).show();
            return false;
