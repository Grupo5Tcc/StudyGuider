            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (!possuiRecuperacao) {
                        Toast.makeText(RecoveryActivity.this, "Não possui nenhuma Recuperação", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(RecoveryActivity.this, "Erro ao recuperar dados", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        db.collection("rec").document(nomeMateria).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(RecoveryActivity.this, "Erro ao carregar dados", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        db.collection("rec").document(nomeMateria)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(RecoveryActivity.this, "Dados de " + nomeMateria + " excluídos com sucesso!", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(RecoveryActivity.this, "Erro ao excluir dados de " + nomeMateria, Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        db.collection("rec").document(nomeMateria).set(dados)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(RecoveryActivity.this, "Dados de " + nomeMateria + " salvos com sucesso!", Toast.LENGTH_SHORT);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(RecoveryActivity.this, "Erro ao salvar dados de " + nomeMateria, Toast.LENGTH_SHORT);
                    }
                });
