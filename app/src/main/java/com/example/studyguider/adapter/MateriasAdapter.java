...
public class MateriasAdapter extends RecyclerView.Adapter<MateriasAdapter.ViewHolder> {
    ...
    private final ArrayList<Materias> arrayList; // Lista de matérias
    private MateriasAdapter.OnItemClickListener onItemClickListener; // Listener para cliques nos itens
    ...
    public MateriasAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MateriasAdapter.ViewHolder(view); // Retorna um novo ViewHolder
    }

    @Override
    public void onBindViewHolder(@NonNull MateriasAdapter.ViewHolder holder, int position) {
        Materias user = arrayList.get(position); // Obtém a matéria correspondente à posição
    ...
    public interface OnItemClickListener {
        void onClick(Materias user); // Método a ser implementado para o clique
    }
}