...
public class ShiftAdapter extends RecyclerView.Adapter<ShiftAdapter.ViewHolder> {
    ...
    private final ArrayList<Shifts> arrayList; // Lista de plantões
    private OnItemClickListener onItemClickListener; // Listener para cliques nos itens

    // Construtor da classe
    public ShiftAdapter(Context context, ArrayList<Shifts> arrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Shifts user = arrayList.get(position); // Obtém o plantão na posição atual
    ...
    private void showConfirmationDialog(Shifts user, int position) {
    ...
    private void deleteUser (Shifts user, int position) {
    ...
    public interface OnItemClickListener {
        void onClick(Shifts user); // Método a ser implementado para o clique
    }
}